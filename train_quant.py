...
def parse():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints_quant/{}_{}/{}/'.format(args.arch, args.dataset, now),
                            help='Folder to save checkpoints')
    parser.add_argument('--log_path', type=str, default='./checkpoints_quant/{}_{}/{}/train.log'.format(args.arch, args.dataset, now),
    ...
    parser.add_argument('--pretrained_weights', type=str, default=pretrained_checkpoint,
...
"""
def get_dump_act(name):
    def dump_act(module, input, output):
        if torch.isnan(output[0]).any():
            print(name)
        else:
            print(name, torch.max(torch.abs(output[0])))
    return dump_act
"""
...
def main():
    ...
    args.pretrained_weights = "./checkpoints_quant/VGGnagaCNN_cifar10/2_18_Time_18_6/checkpoint_1_98.8.tar"
